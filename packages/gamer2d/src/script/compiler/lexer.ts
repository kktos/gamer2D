...
const tokenDefs: TokenDefs = {
	...
	Spritesheet: { pattern: "spritesheet", longer_alt: "Identifier" },
	...
	Animations: { pattern: "animations", longer_alt: "Identifier" },
	...
	Inc: { pattern: "inc", longer_alt: "Identifier" },
	Gap: { pattern: "gap", longer_alt: "Identifier" },
	Rects: { pattern: "rects", longer_alt: "Identifier" },
	Tiles: { pattern: "tiles", longer_alt: "Identifier" },
	Scale: { pattern: "scale", longer_alt: "Identifier" },
	Frames: { pattern: "frames", longer_alt: "Identifier" },
	Length: { pattern: "length", longer_alt: "Identifier" },

	Text: { pattern: "text", longer_alt: "Identifier" },
	Sprite: { pattern: "sprite", longer_alt: "Identifier" },
	Sprites: { pattern: "sprites", longer_alt: "Identifier" },
	...
	Grid: { pattern: "grid", longer_alt: "Identifier" },
